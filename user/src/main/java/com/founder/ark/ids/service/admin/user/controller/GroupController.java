package com.founder.ark.ids.service.admin.user.controller;
...
public class GroupController {
    ...
    public ResponseObject deleteGroup(@PathVariable String id) {
        ...
        Group groupThatWillBeDelete = groupDao.findOne(id);
        if (groupThatWillBeDelete != null && groupThatWillBeDelete.getGroupType().equals("everyone")) {
        ...
        logger.info("执行删除组："+groupThatWillBeDelete.getGroupName());
        try {
